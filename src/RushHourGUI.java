...
public class RushHourGUI extends JFrame implements ActionListener{
	...
	JButton neuButton = new JButton("Neues Spiel"), resButton = new JButton("Restart"), tippButton = new JButton("Hilfe"), 
			...
			beendenButton1 = new JButton("Beenden"), regelnButton = new JButton("Spielregeln"), regelnOK = new JButton("Zur�ck"),
	...
	private void regeln(){
		...
		//einbinden des eigentlichen Textes �ber TxT erforschen.
	...
	public void spielEnde(){
	   	endeLabel.setText("<html>Sie haben gewonnen!<br> Ben�tigte Spielz�ge: "+zuege+"<br> Minimale Spielz�ge: "+spielfeld.getZuege()+"</html>");
